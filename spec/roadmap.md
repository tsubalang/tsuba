...
- `archive/tsonic-checkpoints/carryover-from-tsonic.md` (process + architecture to reuse)
...
- Added `archive/tsonic-checkpoints/checkpoint-tsonic-2026-02-19.md` as a checkpoint reference.
...
- Every non-trivial feature change is mapped to a checkpoint item in `archive/tsonic-checkpoints/carryover-from-tsonic.md`.
