...
describe("@tsuba/compiler diagnostics matrix", () => {
  ...
  const cases: readonly CaseDef[] = [
    ...
    {
      name: "control-flow non-union switch requires literal case labels",
    ...
    {
      name: "entry expressions reject optional chaining",
    ...
    {
      name: "entry expressions reject nullish coalescing",
